...
const SocialItem = ({
  ...
  return (
    <div
      ...
      onClick={onClick}
      className={clsx(
        "relative flex w-full min-h-[6rem] max-w-xl rounded overflow-hidden bg-neutral-800 shadow-card shadow-blue-950/80 hover:bg-white hover:text-black transition-colors pointer-events-auto",
