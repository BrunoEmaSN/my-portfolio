...
const Personality = forwardRef<HTMLDivElement>((_, ref) => {
  return (
    <div ref={ref} className="absolute top-2/3 left-0 w-full md:w-1/2 lg:w-1/3 h-full z-10 flex flex-col">
      <h3 className="text-sm sm:text-base md:text-lg lg:text-xl font-bold skew-x-[-20deg] border-b-2 border-red-600 pb-2 w-fit pl-20 pr-5 text-black">
        PERSONALITY
      </h3>
      <div className='gap-4 p-4'>  
        <div className='relative h-20 flex items-center'>
          ...
          <p className="text-sm sm:text-base md:text-lg lg:text-xl pl-20 text-white text-shadow-lg">
